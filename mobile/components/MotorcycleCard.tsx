...
export default function MotorcycleCard({ motorcycle, onPress, compact, onEdit, onDelete }: MotorcycleCardProps) {
      ...
      <View style={styles.content}>
        ...
        <View style={styles.footer}>
          <Text style={styles.price}>
            ₱{Number(motorcycle.daily_rate).toFixed(0)}
...
const styles = StyleSheet.create({
  ...
  editBtn: { padding: 7, backgroundColor: COLORS.admin + '15', borderRadius: 8 },
  deleteBtn: { padding: 7, backgroundColor: COLORS.error + '15', borderRadius: 8 },
});
